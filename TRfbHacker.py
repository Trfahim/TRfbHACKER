#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To  TR FAHIM
...
#Dev:TRFAHIM
 ...
 \033[1;32m┈┈┈┈┈┈▕▔╲
\033[1;33m┈┈┈┈┈┈┈▏▕\033[1;31m Version : 1.0
\033[1;31m┈┈┈┈┈┈┈▏▕▂▂▂
\033[1;33m▂▂▂▂▂▂╱┈▕▂▂▂▏
\033[1;37m▉▉▉▉▉┈┈┈▕▂▂▂▏
\033[1;31m▉▉▉▉▉┈┈┈▕▂▂▂▏
...
\033[1;37m ▇▇▇▇▇ Credit : \033[1;31m Tahsan Rahman Fahim ▇▇▇▇▇
 \033[1;32m◆━━━━━━◆\033[1;33m YouTube : BD GAMER 8225\033[1;37m ▬▬▬▬▬▬ ◆"""
...
print"   \033[1;90m  Welcome To  TR Hacking World  "
...
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;31m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[1;35m🇧🇩 Welcome to TR Hacking World 🇧🇩☠ ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷 ") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
jalan("\033[0;37m▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇ ▇▶🌷") 
 print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;92m TR Hacking World\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"

 CorrectUsername = "TRFAHIM"
...
def login():
	...
	try:
		...
		print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;92mTR HACKER\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
...
def menu():
	...
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;91mTR HACKER\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"
...
def pilih():
	...
	if unikers =="":
		...
		print " \033[1;91m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•Massage•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\n"
                ...
                jalan("\033[1;96mgit clone https://github.com/TRFAHIM/Trfahim")
                jalan('\033[1;96mcd ')
                jalan('\033[1;96mpython2 ')
                jalan('\033[1;96mUser: TRFAHIM')
                jalan('\033[1;96mpass: HACKER')
...
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.
: \033[1;91m ....TR FAHIM HACKING CLUB....... \033[1;95m :
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;91m FACEBOOK Tahsan Rahman Fahim"""
              raw_input("\n\033[1;95m[\033[1;91mBack\033[1;95m]")
	menu()
...
def pilih_hack():
	...
	def main(arg):
		...
		p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;91mTR HACKER\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
	print "  \033[1;91m«---•◄►•---Developed By TR FAHIM--•◄►•---»" #Dev:Rana
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (0 & Data Reset)↩\033[1;97m....'
	print"\033[1;91mTotal OK/\x1b[1;95mCP \033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
	print """
\033[1;31m╔══╗╔═╗  ╔══╗╔══╗╔╗╔╗╔══╗╔═╦═╗
...
\033[1;31m───────  ─────────────────────
 ...
 Checkpoint ID Open After 7 Days
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.
: \033[1;91m ....Tahsan Rahman Fahim Hacking Club....... \033[1;95m :
•\033[1;95m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;91m FACEBOOK Tahsan Rahman Fahim"""
...
def pilih_black():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;91mTR FAHIM HACKER\033[1;95m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
	print "  \033[1;91m«---•◄►•---Developed By TR-FAHIM--•◄►•---»" #Dev:TR FAHIM
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (0 & Data Reset)↩\033[1;97m....'
	print"\033[1;91mTotal OK/\x1b[1;95mCP \033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
 print"""
 Checkpoint ID Open After 7 Days
...
def pilih_Tiger():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;94mTR FAHIM\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
	print "  \033[1;94m«---•◄►•---Developed By TR-HACKER--•◄►•---»" #Dev:Rana
...
_________$$$$$__$$$$$___$$$$$__$$$$$____
         ...
         Checkpoint ID Open After 7 Days
•\033[1;97m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.
: \033[1;94m .....TR FAHIM HACKING CLUB...... \033[1;97m :
•\033[1;97m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;94m Facebook: Tahsan Rahman Fahim"""
	raw_input("\n\033[1;97m[\033[1;94mBack\033[1;97m]")
	menu()
...
def pilih_test():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•\033[1;94mTR HACKING CLUB\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═•◄►•"
	print "  \033[1;94m«---•◄►•---Developed By TR-HACKER--•◄►•---»" #Dev:TRFAHIM
	print '\033[1;94m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (0 & Data Reset)↩\033[1;97m....'
	print"\033[1;91mTotal OK/\x1b[1;94mCP \033[1;97m: \033[1;97m"+str(len(oks))+"\033[1;97m/\033[1;91m"+str(len(cekpoint))
 print"""
 Checkpoint ID Open After 7 Days
...
•\033[1;97m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;94m FB : Tahsan Rahman Fahim"""
 raw_input("\n\033[1;97m[\033[1;94mBack\033[1;97m]")
	menu()
...
def pilih_super():
 ...
 def main(arg):
	...
	Checkpoint ID Open After 7 Days
•\033[1;97m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.
: \033[1;94m .....TR HACKING CLUB....... \033[1;97m :
•\033[1;97m◄►•═ ═ ═ ═ ═ ═ ═•◄►•═ ═ ═ ═ ═ ═ ═•◄►•.' 
                JOIN ME
              \033[1;94m Tahsan Rahman Fahim"""
 raw_input("\n\033[1;97m[\033[1;94mBack\033[1;97m]")
	menu()
